...
Book1 = Book(names_pm="NAME =  The Book thief", author_pm="Marcuz Suzak", pages_pm=5343,
             yearswriting_pm= "This Book writing of 2005 years",
             contents_pm="История о немецкой девочке по имени Лизель")

print(Book1.names)

Bokok2 = Book(names_pm="NAME =  От Нуля к единице", author_pm="Piter Till", pages_pm=182,
              yearswriting_pm="16 - September, 2014 - yers",
